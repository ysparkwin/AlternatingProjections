...
% Case: ULA       Multi- snapshot
Nsnapshot = 20;
% anglesTrue = [-65; -2; 3]; % +- .5 Line 68

xAxes = [-10 0 10 20 30 40]; % SNR list
...
%     DoA_error = errorDOA(-rad2deg(spRmusic.x_est),anglesTrue);
